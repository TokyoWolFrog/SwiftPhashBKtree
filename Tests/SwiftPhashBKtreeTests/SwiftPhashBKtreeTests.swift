...
final class SwiftPhashBKtreeTests: XCTestCase {
    ...
    func testBKtree() {
        ...
        let selectedNumbers = Array(shuffled.prefix(10))
        ...
        let results = swiftPhashBKTree.search(query: astronaut_M, maxDistance: 3)
        print(results)
        ...
        print(swiftPhashBKTree1.toJSON())
        let results1 = swiftPhashBKTree1.search(query: astronaut_M, maxDistance: 3)
        print(results1)
    }
}
